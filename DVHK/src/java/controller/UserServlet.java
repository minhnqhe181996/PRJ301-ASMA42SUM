    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (user == null) {
            ...
            if (action == null) {
                ...
                RequestDispatcher rs = request.getRequestDispatcher("view/dk_thuong_tru.jsp");
                rs.forward(request, response);
            } else if (action.equals("tr")) {
                RequestDispatcher rs = request.getRequestDispatcher("view/dk_tam_tru.jsp");
                rs.forward(request, response);
            } else if (action.equals("lt")) {
                RequestDispatcher rs = request.getRequestDispatcher("view/khai_bao_luu_tru.jsp");
                rs.forward(request, response);
            }
