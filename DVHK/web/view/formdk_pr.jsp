...
<html>
    ...
    <body>
        ...
        <div class="hero-header overflow-hidden px-5">
            ...
            <h2 class="text-center">Đăng ký thường trú</h2>
            ...
            <form action="Registration" method="post" id="registerForm" class="mx-auto" style="max-width: 1200px;" >
                <input type="hidden" name="action" value="thuong">
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="registerType" name="registerType" readonly="true" value="Permanent">
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                <label for="startDate">Ngày bắt đầu thường trú <span class="text-danger">*</span></label>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="address" name="address" placeholder="Nhập địa chỉ nơi bạn muốn đăng ký thường trú" required>
                            </div>
                            <div class="mb-3">
