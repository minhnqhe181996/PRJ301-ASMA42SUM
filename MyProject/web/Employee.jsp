    ...
    <body>
        ...
        <div class="main-container">
            <div class="employee-header">
                ...
                <p class="subtitle">Quản lý đơn nghỉ phép và điểm danh của bạn</p>
            </div>
            ...
            <div class="menu-list">
                ...
                <!-- MỤC MỚI: Check-in / Check-out -->
                <button class="custom-button" onclick="window.location.href = '${pageContext.request.contextPath}/attendance'">
                    <div class="button-content">
                        <div class="button-icon"><i class="fas fa-clock"></i></div>
                        <div class="button-text">
                            <div class="button-title">Check‑in / Check‑out</div>
                            <div class="button-description">Điểm danh khi vào/ra và xem trạng thái hôm nay</div>
                        </div>
                    </div>
                    <div class="button-arrow"><i class="fas fa-arrow-right"></i></div>
                </button>
