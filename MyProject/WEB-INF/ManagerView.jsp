...
<html lang="en">
<head>
    <title>Manager - Employee Requests</title>
    <style>
...
<div class="container">
    ...
    <table>
        ...
        <% java.util.List<model.RequestDTO> requests = (java.util.List<model.RequestDTO>)request.getAttribute("requests");
           for (model.RequestDTO req : requests) { %>
        <tr>
            <td><%= req.getId() %></td>
            <td><%= req.geteName() %></td>
